...
var isNotPrisoner = function(req, res, next){
...
var isNotVisitor = function(req, res, next){
    User.findOne({_id: req.session.uid}, function(err, user){
...
var eveCell = function(req, res, next){
    User.findOne({_id: req.session.uid}, function(err, user){
...
var malloryCell = function(req, res, next){
    User.findOne({_id: req.session.uid}, function(err, user){
...
app.get('/lobby', isNotPrisoner, function(req, res, next){
    res.sendFile('./html/lobby.html', {root:'./public'});
});
app.get('/visitors-lounge', isNotPrisoner, function(req, res, next){
    res.sendFile('./html/visitors-lounge.html', {root:'./public'});
});
app.get('/cafeteria', isNotVisitor, function(req, res, next){
    res.sendFile('./html/cafeteria.html', {root:'./public'});
});
app.get('/wardens-office', isWarden, function(req, res, next){
    res.sendFile('./html/wardens-office.html', {root:'./public'});
});
app.get('/cell-e', eveCell, function(req, res, next){
    res.sendFile('./html/cell-e.html', {root:'./public'});
});
app.get('/cell-m', malloryCell, function(req, res, next){
